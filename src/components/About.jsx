...
const data = [
  ...
  },
  {
    ...
    details:
      "Dedicated to optimizing the user experience, driving app adoption, and maximizing customer satisfaction. Facilitates smooth onboarding, offers personalized support, and anticipates user needs to foster long-term engagement and loyalty.",
  },
  {
    ...
    duration: "4 months",
    details:
      " I held an essential support role in market research, content creation, sales, product management, data analysis, event organization, customer support, and digital marketing efforts. I was an integral part of the team, contributing to the marketing success of the company or organization.",
  },
  {
