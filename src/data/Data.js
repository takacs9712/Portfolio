export const workExperienceData = [
  {
    ...
    duration: "- Present",
    details: [
      "Worked on the development of a new system, collaborating closely with the backend team to implement new features and enhancements.",
      "In my spare time, I managed tasks related to the old system, and assisted the support team in resolving issues.",
      "Focused on ensuring system stability, fixing bugs, and implementing new functionalities to improve user experience and overall performance.",
    ],
  ...
  },
  {
    ...
    duration: "1 year",
    details: [
      "Participated in the development of a diverse range of websites and applications.",
      "Conducted cross-browser testing to ensure consistent display across different devices and browsers.",
      "Contributed to design discussions, offering suggestions to enhance user interface elements and overall website layout.",
    ],
